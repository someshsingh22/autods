...
class ArgParser(argparse.ArgumentParser):
    def __init__(self, group=None):
        ...
        self.add_argument('--k_experiments', type=int, default=3, help='Branching factor for experiments (>= 1)')
        ...
        self.add_argument('--exploration_weight', type=float, help='Exploration weight for UCB1 selection method',
                          default=1.0)
        self.add_argument('--dataset_metadata_type', type=str, choices=['dbench', 'blade', 'ai2'], default='dbench',
        ...
        self.add_argument('--beam_width', type=int, help='Beam width for beam search selection method')
        ...
        self.add_argument('--k_logs', type=int, default=3,
                          help='Number of parent levels to include in logs (None for all)')
